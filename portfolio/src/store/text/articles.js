//////////// Rassian //////////////
 ...
 const RU_LANGUAGE = 'Русский'
 const RU_MY_NAME = 'Романенко Сергей'
 const RU_NAME_LANGUAGE = 'Язык:'
 const RU_CV = 'Резюме'
 const RU_WORKS = "Мои работы"
 const RU_CONTACT = "Контакты"
 const RU_MAIL = "Эл. почта"
 const RU_PHONE = "Тел."
 const RU_AGE = "Возраст"
